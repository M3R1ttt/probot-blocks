...
Bu topluluğun amacı, herkesin kendini güvende hissettiği, öğrenmeye ve üretmeye
odaklanabildiği bir ortam kurmaktır. Hepimiz farklı geçmişlerden geliyoruz; bu
çeşitliliği bir güç olarak görür, birbirimize saygı ve nezaketle yaklaşırız.
...
## Kapsam
Bu kurallar, depo içindeki tüm alanlarda (Issues, PR’lar, Discussions), çevrimiçi/
çevrimdışı etkinliklerde ve projeyi temsilen bulunduğunuz tüm ortamlarda geçerlidir.

## İhlal Bildirimi
Uygunsuz davranışları şu adrese bildirebilirsiniz: **tunagul54@gmail.com** veya
...
İtiraz süreci e-posta ile yürütülür. Çıkar çatışması olan durumlarda ilgili
sorumlular karar sürecinden çekilir.
...
## Atıf
Bu metin, Contributor Covenant v2.1 dokümanından esinlenilerek uyarlanmıştır:
...
Our goal is to maintain a safe, helpful, and welcoming community where people
can learn and build with confidence.
...
## Scope
Applies to all project spaces (Issues, PRs, Discussions), events (online/offline),
and any public representation of the project.

## Reporting
Report unacceptable behavior to: **tunagul54@gmail.com** or WhatsApp:
**+90 538 040 81 48**
...
Appeals can be submitted via email. Any maintainer with a conflict of interest
